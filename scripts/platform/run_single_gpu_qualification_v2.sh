...
qualification_script="${IPIN_PROJECT_ROOT}/scripts/platform/qualify_torch_gpu_v2.py"
...
run_id="platform-single-gpu-v2-${SLURM_JOB_ID}-${run_timestamp}"
...
echo "Single-GPU qualification v2 completed: ${run_dir}"
