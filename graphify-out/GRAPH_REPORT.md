...
## Corpus Check
- 415 files · ~372,235 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2699 nodes · 6612 edges · 199 communities (140 shown, 59 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 257 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a86ecd16`
...
Cohesion: 0.06
Nodes (90): Counter, _allocation_rows(), build_argument_parser(), _candidate_base_sql(), _candidate_token(), _cell_specs(), CellSpec, construct_artifacts() (+82 more)
...
### Community 37 - "atomic_json"
Cohesion: 0.42
Nodes (9): CompletedProcess, embedding_gpu_hours(), governed_storage_bytes(), invocation_command(), invoke(), logged_training_gpu_seconds(), main(), Path (+1 more)
...
Cohesion: 0.27
Nodes (21): Fail-closed configuration and output guards for component splitting., verify_documents(), _verify_inputs(), Fail-closed configuration and output guards for the pre-split audit., artifact_inventory(), find_table_summary(), iter_table_summaries(), load_json() (+13 more)
...
Cohesion: 0.15
Nodes (20): git_provenance(), load_asset_index(), project_root_from(), Path, Shared ingestion primitives with deterministic IDs and atomic Parquet output., RawAsset, utc_now(), verify_asset() (+12 more)
...
### Community 177 - "test_stage1_embeddings_and_objective.py"
Cohesion: 0.20
...
Cohesion: 0.15
Nodes (33): main(), _artifact(), audit_embeddings(), _check(), Any, Path, Production validation and registry construction for frozen Stage 1 embeddings., Validate both complete snapshots and freeze a content-addressed registry. (+25 more)

### Community 183 - "schema.py"
Cohesion: 0.18
Nodes (10): load_contract(), Path, Load and enforce versioned Arrow table contracts., test_config_freezes_primary_fallback_objective_and_scope(), test_schema_contains_only_split_skeleton_and_aggregate_opportunities(), test_artifact_config_freezes_scope_sampling_and_sealing(), test_schema_has_only_positive_unlabeled_and_role_free_scorer_input(), test_config_preserves_pu_r_parent_and_all_prohibitions() (+2 more)
...
Cohesion: 0.06
Nodes (73): DataType, Schema, _arrow_type(), ContractError, Any, Raised when a schema contract or row violates the frozen contract., SchemaContract, build_argument_parser() (+65 more)

### Community 187 - "training.py"
Cohesion: 0.20
Nodes (18): main(), parameter_count(), learning_rate_multiplier(), Tensor, weighted_pairwise_logistic_loss(), _all_finite(), atomic_torch_checkpoint(), configure_reproducibility() (+10 more)

### Community 188 - "audit.py"
Cohesion: 0.14
Nodes (27): csr_matrix, audit_stage1_implementation(), _check(), Any, Path, Production audit of the frozen Stage 1 implementation before execution., build_training_graph(), common_neighbors_score() (+19 more)
...
Cohesion: 0.19
Nodes (18): deterministic_order(), order_key(), ordered_pair_id_digest(), positive_positions_for_batch(), positive_repetition_counts(), ndarray, rational_weights(), Exact public P-versus-U ordering and rational-weight objective helpers. (+10 more)
...
- **Why does `sha256_file()` connect `sha256_file` to `component_split/pipeline.py`, `require_apptainer`, `tf_isoform_audit/pipeline.py`, `pair_artifacts.py`, `reconciliation/pipeline.py`, `benchmark/systematic_screen_audit.py`, `validation/systematic_screen_audit.py`, `model_governance.py`, `tf_isoform.py`, `estimand_policy_validation.py`, `lambourne_audit/pipeline.py`, `protocol.py`, `construction.py`, `resolve_inside`, `component_split.py`, `pre_split_feasibility.py`, `negative_evidence.py`, `unordered_pair`, `evaluator.py`, `lambourne.py`, `common.py`, `ParquetBatchWriter`, `schema.py`, `staging.py`, `pre_split_audit/pipeline.py`, `stable_id`, `sequence_components.py`, `sequence_component_audit/pipeline.py`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `main()` connect `atomic_json` to `construction.py`, `embeddings.py`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `stable_id()` connect `stable_id` to `intact.py`, `negatome.py`, `tf_isoform_audit/pipeline.py`, `canonical_json`, `sequence_component_audit/semantics.py`, `common.py`, `huri.py`, `ValueError`, `uniprot.py`, `lambourne_audit/pipeline.py`, `pre_split_audit/pipeline.py`, `ParquetBatchWriter`, `unordered_pair`, `sequence_components.py`, `sequence_component_audit/pipeline.py`, `lambourne_audit/source.py`, `sifts.py`?**
...
- **Are the 53 inferred relationships involving `Counter` (e.g. with `main()` and `validate()`) actually correct?**
  _`Counter` has 53 INFERRED edges - model-reasoned connections that need verification._
