...
## Corpus Check
- 453 files · ~408,782 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2983 nodes · 7288 edges · 216 communities (158 shown, 58 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 281 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `66e9126a`
...
Cohesion: 0.06
Nodes (78): build_argument_parser(), _load_json(), _load_yaml(), main(), _nested(), Any, ArgumentParser, Checks (+70 more)
...
Cohesion: 0.15
Nodes (27): Book, Cell, ParquetBatchWriter, Write validated, fixed-schema Parquet parts and retain exact statistics., _append_contact_row(), _append_fusion_row(), _append_generic_workbook_row(), _assert_expected_headers() (+19 more)
...
Cohesion: 0.24
Nodes (22): Counter, _ensembl_by_kind(), _feature_parts(), _identifiers(), _identifiers_for_database(), _interaction_semantics(), _pair_token(), parse_huri() (+14 more)

### Community 137 - "ParsingContext"
Cohesion: 0.19
Nodes (11): ParsingContext, Any, Typed context shared by source parsers., _extract_release(), _mapping_row(), _optional_int(), _parse_gzip_tsv(), parse_sifts() (+3 more)
...
Cohesion: 0.10
Nodes (46): main(), _check(), Any, Path, Production pre-release audit for the DEC-0032 executable boundary., run_audit(), _verified(), Frozen development-only evaluation authorised by DEC-0032. (+38 more)

### Community 146 - "resolve_inside"
Cohesion: 0.23
Nodes (22): Fail-closed configuration and output guards for component splitting., Any, Path, Fail-closed guards for the pair-level PU-R protocol freeze., resolve_and_verify_documents(), Fail-closed configuration and output guards for the pre-split audit., artifact_inventory(), find_table_summary() (+14 more)
...
Cohesion: 0.17
Nodes (21): canonical_json(), stable_id(), _assay_family(), _emit_interaction(), _emit_participant(), _interaction_semantics(), parse_intact(), _parse_mutations() (+13 more)
...
### Community 202 - "_fixture_rows"
Cohesion: 0.67
Nodes (3): _fixture_rows(), ndarray, Table
...
## Knowledge Gaps
- **556 isolated node(s):** `ipin-openppi`, `project_paths.sh script`, `IPIN_APPTAINER_CACHE`, `IPIN_APPTAINER_TMP`, `IPIN_RUNTIME_CACHE` (+551 more)
...
- **Why does `sha256_file()` connect `sha256_file` to `component_split/pipeline.py`, `tf_isoform_audit/pipeline.py`, `evaluator.py`, `reconciliation/pipeline.py`, `common.py`, `validation/systematic_screen_audit.py`, `model_governance.py`, `tf_isoform.py`, `pair_artifacts.py`, `ParquetBatchWriter`, `lambourne_audit/pipeline.py`, `protocol.py`, `tooling.py`, `resolve_inside`, `pre_split_feasibility.py`, `negative_evidence.py`, `construction.py`, `lambourne.py`, `staging.py`, `component_split.py`, `pre_split_audit/pipeline.py`, `FrozenReferenceIndex`, `uniprot.py`, `negative_evidence/pipeline.py`, `sequence_components.py`, `sequence_component_audit/pipeline.py`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `require_within_root()` connect `qualify_torch_gpu.py` to `ValueError`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `audit_training_preparation()` connect `preparation_audit.py` to `training_audit.py`, `Counter`, `objective.py`, `embeddings.py`, `training.py`?**
