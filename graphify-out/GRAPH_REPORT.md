...
## Corpus Check
- 1285 files · ~2,066,523 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6045 nodes · 14124 edges · 487 communities (362 shown, 125 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 606 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `31067488`
...
- submit_training.sh
- test_systematic_screen_audit_validation.py
- _components
...
- Frozen iPIN transfer to six non-human organisms
- original_tuna_investigation_v1/README.md
...
- Q: given that, C3-test results are more reliable than 12-target benchmark. what do you think?
- Q: which model would you actually use for industrial real screening application?
- sha256
...
- test_development_independent_prerelease_validator_v2.py
- test_separately_parameterized_searches_and_exact_normalization
...
## Communities (487 total, 125 thin omitted)
...
Cohesion: 0.10
Nodes (39): Governance-bounded audit of the 2025 human TF-isoform Y2H panel., _bool_token(), _inventory_rows(), _member(), Execute the governance-bounded 2025 TF-isoform Y2H/N2H audit., _semantic_frame(), _source_reconstruction(), classify_y2h_outcome() (+31 more)
...
Cohesion: 0.10
Nodes (54): canonical_json(), _emit_participant(), build_argument_parser(), _decrypt_checked(), evaluate_protected(), main(), open_protected_candidates(), _prediction_rows() (+46 more)
...
Cohesion: 0.08
Nodes (45): _glob(), Path, Register only the frozen local tables admitted by the audit policy., register_evidence_views(), build_candidate_relations(), DuckDBPyConnection, Priority-ordered participant-to-sequence candidate generation., Stop after the first route yielding candidates for a participant. (+37 more)
...
Cohesion: 0.20
Nodes (25): Benchmark-design audits and policy support., build_argument_parser(), _json_field(), _load_json(), _load_yaml(), main(), _nested(), Any (+17 more)
...
Cohesion: 0.05
Nodes (34): BCL2: three frozen iPIN models, Positive-partner ranks, BECN1: three frozen iPIN models, Positive-partner ranks, BRCA1: three frozen iPIN models, Positive-partner ranks, CDK2: three frozen iPIN models, Positive-partner ranks (+26 more)

### Community 13 - "ValueError"
Cohesion: 0.15
Nodes (30): main(), main(), main(), Book, Cell, _raw_bool(), _append_contact_row(), _append_fusion_row() (+22 more)
...
Cohesion: 0.17
Nodes (29): Any, validate_config(), build_argument_parser(), _check_sidecar(), _compare_fields(), _degree_values(), _distribution(), _edge_sets() (+21 more)

### Community 21 - "load_contract"
Cohesion: 0.10
Nodes (38): load_contract(), Path, _allocate(), build_argument_parser(), _check_sidecar(), _component_id(), _components(), _contains() (+30 more)
...
### Community 26 - "investigate.py"
Cohesion: 0.19
Nodes (33): main(), Close this exploratory investigation after validation and preservation checks., main(), Frozen TUnA query replacement, score decomposition, and authors-checkpoint…, score_components(), main(), Post hoc TRAIN/validation sequence-relative audit, never reading original test., check_inputs() (+25 more)

### Community 27 - "test_external_bioplex.py"
Cohesion: 0.10
Nodes (33): allowed_url(), tsv(), accession_lookup(), classify(), make_panel(), positive_interval(), project_source(), Directed external-panel semantics, independent of model fitting. (+25 more)
...
### Community 31 - "sha256_file"
Cohesion: 0.11
Nodes (25): main(), Shared ingestion primitives with deterministic IDs and atomic Parquet output., Load and enforce versioned Arrow table contracts., sha256_file(), Path, Map source accessions to the frozen human UniProt sequence reference., _download(), _load_yaml() (+17 more)
...
Cohesion: 0.16
Nodes (32): _allocation_summary(), _base_component_order(), _build_aggregate_tables(), build_argument_parser(), _claim_rows(), _component_degree_row(), _component_summary(), _degree_row() (+24 more)

### Community 109 - "ParsingContext"
Cohesion: 0.12
Nodes (27): RawAsset, ParsingContext, Any, _assay_family(), _emit_interaction(), _interaction_semantics(), parse_intact(), _parse_mutations() (+19 more)
...
Cohesion: 0.08
Nodes (18): RAPPPID latest recovery checkpoints: C1/C2/C3 test, Completed comparisons, Execution and provenance, Model benchmarks, Predictor scope and limitations, TUnA benchmark, TUnA final benchmark results, Apptainer environments (+10 more)
...
### Community 127 - "test_composition_order.py"
Cohesion: 0.12
Nodes (25): Frozen explanatory diagnostics of composition, order and partner matching., build_matches(), diagnostic_flags(), encode(), frequencies(), lower_above(), Order-free controls and matched within-bait estimands; no fitting., Enumerate all caliper-eligible U, never consulting a learned score. (+17 more)

### Community 128 - "sha256_file"
Cohesion: 0.05
Nodes (103): main(), main(), Production audit of the frozen Stage 1 implementation before execution., Exact constants frozen by DEC-0028 and activated by DEC-0030., _all_finite(), _artifact(), audit_embeddings(), _check() (+95 more)
...
### Community 135 - "sha"
Cohesion: 0.25
Nodes (18): audit(), Path, Read-only full-census replay of development selection and training records., close(), historical_integrity(), Path, Immutable artifact helpers and the prospective recipe census., read() (+10 more)

### Community 136 - "AuditReferenceMaps"
Cohesion: 0.47
Nodes (4): AuditReferenceMaps, Any, Path, _sorted_strings()
...
Cohesion: 0.10
Nodes (56): Fail-closed configuration and output guards for component splitting., Any, Path, Fail-closed guards for the pair-level PU-R protocol freeze., resolve_and_verify_documents(), validate_config(), _verify_inputs(), Fail-closed configuration and output guards for the pre-split audit. (+48 more)
...
Cohesion: 0.09
Nodes (47): main(), _check(), _fixture_rows(), Any, ndarray, Path, Table, Production pre-release audit for the DEC-0032 executable boundary. (+39 more)

### Community 146 - "pair_protocol/pipeline.py"
Cohesion: 0.12
Nodes (26): Frozen pair-level positive-unlabeled ranking protocol., _degree_analysis(), Aggregate-only feasibility audit for the frozen pair-level PU-R protocol., c1_role(), choose_two(), degree_bin(), degree_histogram(), degree_pair_stratum() (+18 more)
...
### Community 151 - "f"
Cohesion: 0.06
Nodes (70): download(), main(), Download immutable public source archives; checksum and validate every member., load_metrics(), main(), Prespecified target-level PU retrieval and paired descriptive comparisons., human_data(), main() (+62 more)
...
Cohesion: 0.18
Nodes (10): Fixed-ensemble follow-up on the existing test v1, Fixed predictor and acceptance, Metrics and interpretation, Qualification before access, Staged execution and baseline, Execution, amendment and verification, Fixed-ensemble test follow-up v1, Outcome (+2 more)
...
Cohesion: 0.06
Nodes (64): load_asset_index(), Any, stable_id(), verify_asset(), conflict_overlays(), effective_tier(), permitted_role(), Reliability tiers and conflict overlays for conditional negative evidence. (+56 more)
...
### Community 190 - "external_bioplex/pipeline.py"
Cohesion: 0.06
Nodes (72): save_npz(), compute(), evaluate(), match_census(), point_record(), A single frozen execution: features and matches, then explanatory readout., restricted_queries(), score_map() (+64 more)
...
### Community 200 - "pre_split_audit/semantics.py"
Cohesion: 0.11
Nodes (25): allocate_components(), allocation_order(), degree_gini(), degree_histogram(), degree_summary(), deterministic_components(), DisjointSet, nearest_rank() (+17 more)

### Community 201 - "project_root_from"
Cohesion: 0.07
Nodes (56): RecordBatch, build_argument_parser(), _load_json(), _load_yaml(), main(), _nested(), Any, ArgumentParser (+48 more)

### Community 202 - "model_optimization/run.py"
Cohesion: 0.15
Nodes (19): build(), features(), load_state(), PairHead, Module, Tensor, Small symmetric heads for existing, training-standardized frozen PLM vectors., save_state() (+11 more)
...
Cohesion: 0.12
Nodes (32): alignment_scores(), alignment_values(), exhaustive_transfer_numpy(), fit_rows(), panel_mask(), purged_fit_mask(), Pure homology, source visibility and transfer primitives., Hide target-only public P as unit-weight U, never use target exclusion. (+24 more)
...
### Community 206 - "negative_evidence.py"
Cohesion: 0.06
Nodes (78): DataType, Schema, _arrow_type(), ContractError, Any, Raised when a schema contract or row violates the frozen contract., SchemaContract, DuckDBPyConnection (+70 more)
...
### Community 213 - "audit_stage1_implementation"
Cohesion: 0.07
Nodes (39): EndpointHead, Matched additive endpoint controls; the historical pair head is unchanged., audit_stage1_implementation(), _check(), Any, Path, build_training_graph(), common_neighbors_score() (+31 more)
...
### Community 244 - "scan_tar_gzip_archive"
Cohesion: 0.13
...
Cohesion: 0.12
Nodes (30): Governance-bounded final benchmark component-partition skeleton., build_argument_parser(), _edge_set(), _load_graphs(), _load_parent_state(), _load_positive_pairs(), main(), Any (+22 more)
...
### Community 260 - "test_huri_workbooks_v2.py"
Cohesion: 0.12
Nodes (10): SimpleNamespace, _asset(), CaptureWriter, _config(), test_contact_annotation_is_typed_but_never_label_authorized(), test_fusion_interference_preserves_orientation_and_missingness(), test_staging_v2_contract_and_active_parser_version(), test_workbook_headers_are_strict() (+2 more)
...
### Community 264 - "lambourne_audit/semantics.py"
Cohesion: 0.13
...
Cohesion: 0.09
Nodes (70): config(), freeze(), prior_closures(), Fail-closed, append-only registration for a diagnostic of existing evidence., register(), runtime(), save_numpy(), verify_freeze() (+62 more)
...
Cohesion: 0.08
Nodes (52): build_argument_parser(), _candidate_sql(), _candidate_union_check(), Checks, _decrypt_package(), _expected_positive_keys(), IndependentSpec, main() (+44 more)
...
Cohesion: 0.22
Nodes (4): skipUnless, PreservationFixtures, Synthetic preservation tests: no benchmark pairs, labels or evaluation entry., registry_fixture()
...
### Community 323 - "run_audit"
Cohesion: 0.20
Nodes (21): _aggregate_findings(), build_argument_parser(), _build_group_rows(), _build_mapping_rows(), _build_n2h_rows(), _load_json(), _load_yaml(), main() (+13 more)

### Community 324 - "pipeline_v4.py"
Cohesion: 0.18
Nodes (13): _CardinalityCorrectingWriter, _correct_participant_cardinality(), _emit_interaction_v3(), Any, IntAct parser revision with exact unary/binary/n-ary semantics. Revision 2…, main(), _option_present(), Active parser routing for the primary-source v1 staging snapshot. (+5 more)
...
### Community 326 - "ParquetBatchWriter"
Cohesion: 0.15
Nodes (20): ParquetBatchWriter, Write validated, fixed-schema Parquet parts and retain exact statistics., strip_version(), Typed context shared by source parsers., _clean_annotation(), iter_fasta(), parse_dat_metadata(), _parse_fasta_header() (+12 more)
...
Cohesion: 0.07
Nodes (26): RAPPPID benchmark, Artifacts, Coverage, verification and timing, Exact selected states and inference policy, RAPPPID: latest saved checkpoints on C1/C2/C3 test, Results, Container and numerical qualification, Evaluation protocol and timing (+18 more)
...
### Community 338 - "align_embedding_matrix"
Cohesion: 0.24
...
### Community 339 - "unordered_pair"
Cohesion: 0.15
Nodes (23): FamilyMap, build_contamination_index(), contamination_flags(), ContaminationIndex, _family_pair_signatures(), load_negatome_pair_index(), load_sequence_family_maps(), Any (+15 more)
...
### Community 351 - "component_split/semantics.py"
Cohesion: 0.16
...
### Community 358 - "lambourne_audit/source.py"
Cohesion: 0.28
...
### Community 359 - "Counter"
Cohesion: 0.40
Nodes (14): Counter, _prepare_state(), _analyze(), _candidate_designs(), _cell_summary(), _evidence_completeness(), _load_endpoints(), _load_positive_pairs() (+6 more)
...
### Community 366 - "Frozen iPIN transfer to six non-human organisms"
Cohesion: 0.09
Nodes (19): Evidence adjustment before any model scoring, Completion, Evidence and sequence identity, Frozen iPIN transfer to six non-human organisms, Frozen scoring, Metrics and uncertainty, Panels, selected before model inference, Question and scope (+11 more)
...
### Community 382 - "AST"
Cohesion: 0.19
Nodes (8): AST, main(), Audit committed score prefixes without opening test labels or changing jobs., read(), _load_module(), test_independent_window_order_and_parameter_algebra(), _module(), test_independent_preparation_matrix_and_order_fixture()
...
### Community 415 - "model_optimization/metrics.py"
Cohesion: 0.16
Nodes (16): publish(), Path, Validate the completed development search and release aggregate evidence only., bootstrap(), gate(), point(), ndarray, Exact weighted PU concordance and paired component resampling on CUDA. (+8 more)
...
### Community 419 - "validate_development_prerelease_independent_v3.py"
Cohesion: 0.53
...
### Community 433 - "test_systematic_screen_audit_validation.py"
Cohesion: 0.36
Nodes (12): _audit(), _config(), _guardrail_failures(), parametrize, Path, test_report_scope_must_share_run_directory(), test_report_scope_rules(), test_valid_audit_guardrails_pass() (+4 more)

### Community 434 - "_components"
Cohesion: 0.27
...
### Community 436 - "audit_protocol"
Cohesion: 0.36
Nodes (9): audit_protocol(), build_argument_parser(), main(), ArgumentParser, Path, _register_views(), _timestamp(), _verify_explicit_summary() (+1 more)
...
### Community 456 - "Frozen iPIN transfer to six non-human organisms"
Cohesion: 0.22
Nodes (8): Completion, Evidence and sequence identity, Frozen iPIN transfer to six non-human organisms, Frozen scoring, Metrics and uncertainty, Panels, selected before model inference, Question and scope, Training exposure and similarity

### Community 457 - "original_tuna_investigation_v1/README.md"
Cohesion: 0.29
Nodes (5): Interpretation and preservation, Original TUnA example investigation, Questions and fixed diagnostics, Original TUnA investigation, Reproduction
...
### Community 459 - "validate"
Cohesion: 0.71
Nodes (7): _independent_nullability_check(), _load_hash_pinned_base(), Any, Path, _sha256(), validate(), _write_json()

### Community 461 - "Why original TUnA performs well in the twelve-target example"
Cohesion: 0.29
Nodes (7): 1. The main difference is EGFR, 2. A specific training-data explanation for EGFR, 3. The model responds to the query target, 4. Candidate selection makes the absolute scores look stronger, 5. Scoring and numerical explanations checked, 6. Different training tasks, different evaluation populations, Why original TUnA performs well in the twelve-target example
...
### Community 463 - "Frozen iPIN pair models v2"
Cohesion: 0.40
...
### Community 466 - "Q: given that, C3-test results are more reliable than 12-target benchmark. what do you think?"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: given that, C3-test results are more reliable than 12-target benchmark. what do you think?, Source Nodes

### Community 467 - "Q: which model would you actually use for industrial real screening application?"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: which model would you actually use for industrial real screening application?, Source Nodes

### Community 468 - "sha256"
Cohesion: 0.80
Nodes (4): download(), main(), package(), sha256()

### Community 469 - "test_development_completed_independent_validator.py"
Cohesion: 0.60
Nodes (3): _module(), test_independent_metric_ties_and_component_draws(), test_independent_model_forward_is_swap_symmetric()

### Community 470 - "test_development_independent_prerelease_validator.py"
Cohesion: 0.60
Nodes (3): _module(), test_clean_room_ht_half_tie_and_component_multiplier(), test_clean_room_nonlinear_forward_is_swap_symmetric()

### Community 471 - "Q: how possible the original tuna is so good? investigate it."
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: how possible the original tuna is so good? investigate it., Source Nodes

### Community 472 - "Frozen pair models v1"
Cohesion: 0.50
Nodes (4): Claim boundaries, Exact prediction definition, Frozen pair models v1, Preservation and verification

### Community 473 - "test_development_independent_prerelease_validator_v3.py"
Cohesion: 0.60
Nodes (3): _module(), test_revision_3_clean_room_degree_semantics_fixture(), test_revision_3_validator_rejects_source_hash_drift()

### Community 477 - "CDK2 biological partner panel"
Cohesion: 0.50
Nodes (4): CDK2 biological partner panel, Exposure, Nominated positives, Unlabeled controls

### Community 478 - "HIF1A biological partner panel"
Cohesion: 0.50
Nodes (4): Exposure, HIF1A biological partner panel, Nominated positives, Unlabeled controls

### Community 480 - "build_positive_pair_index"
Cohesion: 0.50
Nodes (4): build_positive_pair_index(), Any, DuckDBPyConnection, Index current binary mapped positives and reproducible HuRI-family views.

### Community 481 - "DEC-0055: Freeze TUnA-retrained as the third iPIN model"
Cohesion: 0.50
Nodes (4): DEC-0055: Freeze TUnA-retrained as the third iPIN model, Evidence and interpretation, Execution boundary, Fixed model identity

### Community 483 - "test_separately_parameterized_searches_and_exact_normalization"
Cohesion: 0.50
Nodes (3): Path, skipif, test_separately_parameterized_searches_and_exact_normalization()

## Knowledge Gaps
- **1305 isolated node(s):** `build_dscript.sh script`, `APPTAINER_CACHEDIR`, `APPTAINER_TMPDIR`, `TMPDIR`, `PYTHONDONTWRITEBYTECODE` (+1300 more)
...
- `Reference-sequence Positive-Unlabeled Ranking` (4× useful, score=1.474526661)
- `component_split.py` (3× useful, score=2.16762354)
- `tuna/scripts/frozen_scorer.py` (2× useful, score=1.9922831)
- `twelve_target_comparison_v1/REPORT.md` (2× useful, score=1.990136731)
- `protected_final_core_v1.py` (2× useful, score=1.61544576)
- `ensemble_columns_exact()` (2× useful, score=1.612907561)
- `DEC-0050: Bound the data feasibility check; stop the current model track` (2× useful, score=1.608096347)
- `composition_order/pipeline.py` (2× useful, score=1.606881317)
- `composition_order/validation.py` (2× useful, score=1.606881317)
- `validation/systematic_screen_audit.py` (2× useful, score=1.597228749)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `f()` connect `f` to `write`, `read`, `recovery_test_v1/comparison.py`, `plm_interact/scripts/comparison.py`, `scripts/pipeline.py`, `read`, `sprint/scripts/comparison.py`, `read`, `AST`, `partner_specificity/pipeline.py`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `sha256_file()` connect `sha256_file` to `tf_isoform_audit/pipeline.py`, `canonical_json`, `lambourne.py`, `benchmark/systematic_screen_audit.py`, `lambourne_audit/pipeline.py`, `sequence_component_audit/pipeline.py`, `model_governance.py`, `validation/systematic_screen_audit.py`, `tf_isoform.py`, `staging.py`, `pair_protocol/pipeline.py`, `pre_split_feasibility.py`, `load_contract`, `construction.py`, `pair_artifacts.py`, `audit_protocol`, `stable_id`, `run_audit`, `ParquetBatchWriter`, `project_root_from`, `negative_evidence.py`, `pre_split_audit/pipeline.py`, `sequence_components.py`, `component_split/pipeline.py`, `protocol.py`?**
...
- **Are the 91 inferred relationships involving `Counter` (e.g. with `main()` and `main()`) actually correct?**
  _`Counter` has 91 INFERRED edges - model-reasoned connections that need verification._
