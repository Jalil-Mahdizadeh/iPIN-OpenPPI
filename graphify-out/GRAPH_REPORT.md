...
## Corpus Check
- 498 files · ~466,224 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3178 nodes · 7647 edges · 237 communities (179 shown, 58 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 287 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3e867494`
...
Cohesion: 0.06
Nodes (86): Counter, _allocation_rows(), build_argument_parser(), _candidate_base_sql(), _candidate_token(), _cell_specs(), CellSpec, _construct_into() (+78 more)
...
Cohesion: 0.15
Nodes (31): Governance-bounded audit of the Lambourne et al. human Y2H-v1 panel., _aggregate_panel_metrics(), _archive_inventory_rows(), _bool_value(), build_parser(), _family_ids_for_candidates(), _load_json(), _load_yaml() (+23 more)
...
Cohesion: 0.18
Nodes (20): canonical_json(), Shared ingestion primitives with deterministic IDs and atomic Parquet output., strip_version(), Typed context shared by source parsers., _clean_annotation(), iter_fasta(), parse_dat_metadata(), _parse_fasta_header() (+12 more)
...
### Community 160 - "resolve_inside"
Cohesion: 0.18
Nodes (29): Path, Fail-closed configuration and output guards for component splitting., require_output_paths(), construct_artifacts(), verify_documents(), Path, Fail-closed guards for the pair-level PU-R protocol freeze., resolve_and_verify_documents() (+21 more)
...
### Community 167 - "lambourne_audit/source.py"
Cohesion: 0.30
...
Cohesion: 0.19
Nodes (21): build_argument_parser(), _load_json(), _load_yaml(), main(), _nested(), Any, ArgumentParser, Checks (+13 more)
...
### Community 214 - "git_provenance"
Cohesion: 0.19
Nodes (16): git_provenance(), load_asset_index(), Path, RawAsset, verify_asset(), build_argument_parser(), main(), _make_read_only() (+8 more)

### Community 215 - "reconciliation_semantics.py"
Cohesion: 0.38
Nodes (16): Checks, DuckDBPyConnection, Path, _query_scalar(), Independent row-level checks for the primary reconciliation artifact., _record_zero_counts(), register_canonical_views(), register_staging_views() (+8 more)
...
Cohesion: 0.14
Nodes (16): ParquetBatchWriter, Any, Write validated, fixed-schema Parquet parts and retain exact statistics., _extract_release(), _mapping_row(), _optional_int(), _parse_gzip_tsv(), parse_sifts() (+8 more)
...
### Community 236 - "degree_pair_stratum"
Cohesion: 0.67
Nodes (4): degree_bin(), degree_pair_stratum(), parametrize, test_degree_bins()

## Knowledge Gaps
- **624 isolated node(s):** `ipin-openppi`, `project_paths.sh script`, `IPIN_APPTAINER_CACHE`, `IPIN_APPTAINER_TMP`, `IPIN_RUNTIME_CACHE` (+619 more)
...
- **Why does `sha256_file()` connect `sha256_file` to `tf_isoform_audit/pipeline.py`, `require_apptainer`, `evaluator.py`, `construction.py`, `reconciliation/pipeline.py`, `benchmark/systematic_screen_audit.py`, `project_root_from`, `model_governance.py`, `validation/systematic_screen_audit.py`, `pair_artifacts.py`, `tf_isoform.py`, `lambourne_audit/pipeline.py`, `protocol.py`, `staging.py`, `pre_split_feasibility.py`, `negative_evidence.py`, `lambourne.py`, `resolve_inside`, `negative_evidence/pipeline.py`, `component_split.py`, `schema.py`, `component_split/pipeline.py`, `reconciliation.py`, `stable_id`, `pair_protocol.py`, `git_provenance`, `ParquetBatchWriter`, `common.py`, `sequence_components.py`, `sequence_component_audit/pipeline.py`?**
