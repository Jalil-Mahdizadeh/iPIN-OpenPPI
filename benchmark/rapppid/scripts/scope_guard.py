...
def main():
    ...
    parser.add_argument("--snapshot", type=Path, help="Per-run snapshot inside benchmark/rapppid/")
    ...
    if CANDIDATE not in before.parents:
        raise ValueError("Scope-audit outputs must remain inside benchmark/rapppid/")
