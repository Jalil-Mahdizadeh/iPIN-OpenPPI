...
| R-015 | A selected conditional non-detection panel is treated as a representative population-negative sample | High | Critical | Bounded Lambourne audit authorized under DEC-0013; preserve full denominator and technical states, keep outcomes out of training, test pair/family leakage, and return to governance before any integration | Codex | Active; controlled |
| R-016 | Preview-only IMEx curation is mistaken for a stable current IntAct release | High | High | Freeze IM-30553 exports as a dated preview with local hashes; keep them separate from Release 252 and track ISSUE-0006 | Codex | Active; controlled |
