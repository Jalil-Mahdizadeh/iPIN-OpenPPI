...
| R-015 | A selected conditional non-detection panel is treated as a representative population-negative sample | High | Critical | Keep conditional negatives protected and source-/assay-stratified; no training role; require selected/attempted/evaluable denominator, sampling audit, and new gate before any future panel use | Codex | Open |
