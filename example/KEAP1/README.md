...
Prepared 2026-09-18T22:00:01.123399+00:00. Input only: no model inference or training was run.

[keap1_ipin_panel.csv](keap1_ipin_panel.csv) contains **3 P + 300 U = 303 pairs**. Its five columns exactly match ../ire1_ipin_panel2.csv:

`query_gene,query_uniprot,partner_gene,partner_uniprot,class`

The query is human KEAP1 (Q14145); the gene/accession pairs were checked against UniProt 2026_03 (02-September-2026). Accessions refer to canonical sequences. [panel_manifest.json](panel_manifest.json) records the query and partner sequence SHA-256 values, sequence lengths, selection groups, source hashes, and overlap checks. The CSV itself intentionally contains neither sequences nor model scores.

## Positive partners

| Partner | UniProt | Pair type | Evidence / context |
|---|---|---|---|
| NFE2L2 | Q16236 | Heteromeric | [Evidence](https://pubmed.ncbi.nlm.nih.gov/15601839/) — KEAP1-NRF2 substrate recognition. |
| CUL3 | Q13618 | Heteromeric | [Evidence](https://pubmed.ncbi.nlm.nih.gov/15601839/) — KEAP1-CUL3 ubiquitin-ligase complex interaction. |
| SQSTM1 | Q13501 | Heteromeric | [Evidence](https://pubmed.ncbi.nlm.nih.gov/20452972/) — Direct p62/SQSTM1 binding to the KEAP1 Kelch-repeat domain. Previously present as a development positive. |
...
|---|---|---|---|
| NFE2L2 | context | 4-53 | cytoplasm; TRANSMEM=false |
| NFE2L2 | background | 54-103 | No compartment/TM restriction |
| CUL3 | context | 104-153 | cytoplasm; TRANSMEM=false |
| CUL3 | background | 154-203 | No compartment/TM restriction |
| SQSTM1 | context | 204-253 | cytoplasm; TRANSMEM=false |
| SQSTM1 | background | 254-303 | No compartment/TM restriction |

## Exposure and interpretation

KEAP1-SQSTM1: DEV_P. Retained as the nominated positive; this is NOT an independent held-out positive.
...
- [UniProt target record](https://rest.uniprot.org/uniprotkb/Q14145.json)
...
- [IntAct interaction query](https://www.ebi.ac.uk/Tools/webservices/psicquic/intact/webservices/current/search/query/id%3AQ14145%2A?format=tab25&firstResult=0&maxResults=2500)
