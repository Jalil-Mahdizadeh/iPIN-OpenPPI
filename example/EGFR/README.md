...
Prepared 2026-09-18T22:00:00.842053+00:00. Input only: no model inference or training was run.

[egfr_ipin_panel.csv](egfr_ipin_panel.csv) contains **3 P + 300 U = 303 pairs**. Its five columns exactly match ../ire1_ipin_panel2.csv:

`query_gene,query_uniprot,partner_gene,partner_uniprot,class`

The query is human EGFR (P00533); the gene/accession pairs were checked against UniProt 2026_03 (02-September-2026). Accessions refer to canonical sequences. [panel_manifest.json](panel_manifest.json) records the query and partner sequence SHA-256 values, sequence lengths, selection groups, source hashes, and overlap checks. The CSV itself intentionally contains neither sequences nor model scores.

## Positive partners

| Partner | UniProt | Pair type | Evidence / context |
|---|---|---|---|
| GRB2 | P62993 | Heteromeric | [Evidence](https://pubmed.ncbi.nlm.nih.gov/7518560/) — Phosphorylation-dependent GRB2 binding to EGFR. |
| SHC1 | P29353 | Heteromeric | [Evidence](https://pubmed.ncbi.nlm.nih.gov/7518560/) — Phosphorylation-dependent SHC binding to EGFR. |
| CBL | P22681 | Heteromeric | [Evidence](https://www.uniprot.org/uniprotkb/P00533/entry) — Curated human EGFR-CBL interaction; receptor activation/phosphorylation is relevant. |
...
|---|---|---|---|
| GRB2 | context | 4-53 | cytoplasm; TRANSMEM=false |
| GRB2 | background | 54-103 | No compartment/TM restriction |
| SHC1 | context | 104-153 | cytoplasm; TRANSMEM=false |
| SHC1 | background | 154-203 | No compartment/TM restriction |
| CBL | context | 204-253 | cytoplasm; TRANSMEM=false |
| CBL | background | 254-303 | No compartment/TM restriction |
...
- [UniProt target record](https://rest.uniprot.org/uniprotkb/P00533.json)
...
- [IntAct interaction query](https://www.ebi.ac.uk/Tools/webservices/psicquic/intact/webservices/current/search/query/id%3AP00533%2A?format=tab25&firstResult=0&maxResults=2500)
