...
Prepared 2026-09-18T22:00:00.973560+00:00. Input only: no model inference or training was run.

[bcl2_ipin_panel.csv](bcl2_ipin_panel.csv) contains **3 P + 300 U = 303 pairs**. Its five columns exactly match ../ire1_ipin_panel2.csv:

`query_gene,query_uniprot,partner_gene,partner_uniprot,class`

The query is human BCL2 (P10415); the gene/accession pairs were checked against UniProt 2026_03 (02-September-2026). Accessions refer to canonical sequences. [panel_manifest.json](panel_manifest.json) records the query and partner sequence SHA-256 values, sequence lengths, selection groups, source hashes, and overlap checks. The CSV itself intentionally contains neither sequences nor model scores.

## Positive partners

| Partner | UniProt | Pair type | Evidence / context |
|---|---|---|---|
| BCL2L11 | O43521 | Heteromeric | [Evidence](https://pubmed.ncbi.nlm.nih.gov/15694340/) — BH3-mediated BIM binding to BCL2; full canonical protein is listed, not a BH3 peptide. |
| BAD | Q92934 | Heteromeric | [Evidence](https://pubmed.ncbi.nlm.nih.gov/15694340/) — BH3-mediated BAD binding to BCL2. |
| BBC3 | Q9BXH1 | Heteromeric | [Evidence](https://pubmed.ncbi.nlm.nih.gov/15694340/) — BH3-mediated PUMA binding to BCL2. |
...
|---|---|---|---|
| BCL2L11 | context | 4-53 | mitochondrion; TRANSMEM=false |
| BCL2L11 | background | 54-103 | No compartment/TM restriction |
| BAD | context | 104-153 | mitochondrion; TRANSMEM=false |
| BAD | background | 154-203 | No compartment/TM restriction |
| BBC3 | context | 204-253 | mitochondrion; TRANSMEM=false |
| BBC3 | background | 254-303 | No compartment/TM restriction |
...
- [UniProt target record](https://rest.uniprot.org/uniprotkb/P10415.json)
...
- [IntAct interaction query](https://www.ebi.ac.uk/Tools/webservices/psicquic/intact/webservices/current/search/query/id%3AP10415%2A?format=tab25&firstResult=0&maxResults=2500)
