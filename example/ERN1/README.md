...
Prepared 2026-09-18T22:00:00.515689+00:00. Input only: no model inference or training was run.

[ern1_ipin_panel.csv](ern1_ipin_panel.csv) contains **4 P + 400 U = 404 pairs**. Its five columns exactly match ../ire1_ipin_panel2.csv:

`query_gene,query_uniprot,partner_gene,partner_uniprot,class`

The query is human ERN1 (O75460); the gene/accession pairs were checked against UniProt 2026_03 (02-September-2026). Accessions refer to canonical sequences. [panel_manifest.json](panel_manifest.json) records the query and partner sequence SHA-256 values, sequence lengths, selection groups, source hashes, and overlap checks. The CSV itself intentionally contains neither sequences nor model scores.

## Positive partners

| Partner | UniProt | Pair type | Evidence / context |
|---|---|---|---|
| ERN1 | O75460 | Homomeric | [Evidence](https://pubmed.ncbi.nlm.nih.gov/16973740/) — Human IRE1alpha dimerization interface; structural and mutational evidence. Self-association is retained as P. |
| HSPA5 | P11021 | Heteromeric | [Evidence](https://www.sciencedirect.com/science/article/pii/S0092867417312667) — BiP interaction with the IRE1alpha luminal domain; ERdj4-assisted regulation. |
| PDIA6 | Q15084 | Heteromeric | [Evidence](https://pubmed.ncbi.nlm.nih.gov/24508390/) — Direct, disulfide-dependent PDIA6 association with the IRE1alpha luminal region. |
| SEC61A1 | P61619 | Heteromeric | [Evidence](https://pmc.ncbi.nlm.nih.gov/articles/PMC4456659/) — Sec61alpha association supported by cellular crosslinking; the translocon context is relevant. |
...
|---|---|---|---|
| ERN1 | context | 5-54 | endoplasmic reticulum; TRANSMEM=true |
| ERN1 | background | 55-104 | No compartment/TM restriction |
| HSPA5 | context | 105-154 | endoplasmic reticulum; TRANSMEM=false |
| HSPA5 | background | 155-204 | No compartment/TM restriction |
| PDIA6 | context | 205-254 | endoplasmic reticulum; TRANSMEM=false |
| PDIA6 | background | 255-304 | No compartment/TM restriction |
| SEC61A1 | context | 305-354 | endoplasmic reticulum; TRANSMEM=true |
| SEC61A1 | background | 355-404 | No compartment/TM restriction |
...
The ERN1-ERN1, ERN1-HSPA5 and ERN1-PDIA6 positives were already used in the earlier example/ire1_ipin_panel2.csv panel. They are disclosed follow-up examples, not untouched validation.
...
- [UniProt target record](https://rest.uniprot.org/uniprotkb/O75460.json)
...
- [IntAct interaction query](https://www.ebi.ac.uk/Tools/webservices/psicquic/intact/webservices/current/search/query/id%3AO75460%2A?format=tab25&firstResult=0&maxResults=2500)
